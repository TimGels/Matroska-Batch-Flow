...
public partial class WritableJsonSettings<T>
{
    ...
    [LoggerMessage(EventId = UnoLogEvents.Settings.DeserializationFailed, Level = LogLevel.Warning, Message = "Failed to deserialize settings from {FilePath}, using defaults")]
    ...
    [LoggerMessage(EventId = UnoLogEvents.Settings.LoadFailed, Level = LogLevel.Error, Message = "Failed to load settings from {FilePath}, using defaults")]
