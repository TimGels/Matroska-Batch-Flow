namespace MKVBatchFlow.Uno.UITests;

public class Constants
{
    public readonly static string WebAssemblyDefaultUri = "http://localhost:5000/";
    public readonly static string iOSAppName = "com.companyname.MKVBatchFlow.Uno";
    public readonly static string AndroidAppName = "com.companyname.MKVBatchFlow.Uno";
