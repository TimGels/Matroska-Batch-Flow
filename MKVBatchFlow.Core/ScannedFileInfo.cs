using static MKVBatchFlow.Core.ScannedFileInfo;
using static MKVBatchFlow.Core.ScannedFileInfo.MediaInfo;
using static MKVBatchFlow.Core.ScannedFileInfo.MediaInfo.TrackInfo;

namespace MKVBatchFlow.Core
{
    /// <summary>
    /// Represents the information of a scanned media file including its file path, media information summary, the library that created it, and detailed metadata.
    /// </summary>
    public sealed record ScannedFileInfo(
        /// <summary>
        /// The file path to the scanned media file.
        /// </summary>
        string FilePath,

        /// <summary>
        /// A summary of the media information of the scanned file.
        /// </summary>
        string MediaInfoSummary,
